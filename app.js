...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    var sumMult = [];
    sumMult.push(sum(sum(a, b)[0], c)[0]);
    sumMult.push(multiply(multiply(a, b)[0], c)[0]);
    sumMult.push(a + ' and ' + b + ' and ' + c + ' sum to ' + sumMult[0] + '.');
    sumMult.push('The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + sumMult[1] + '.')
    return sumMult;
}
...
function sumArray(sumArra) { //eslint-disable-line
    var sumArra = []
    sumArra.push(sum(sum(testArray[0], testArray[1])[0], testArray[2])[0]);
    sumArra.push(testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + sumArra[0] + ' is their sum.');
    return sumArra;
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    var output = [];
    var product = 1;
    var numberString = dynamicArray.join(',');
    for(var i = 0; i < dynamicArray.length; i++){
      product = multiply(product, dynamicArray[i])[0];
    }
    output.push(product);
    output.push('The numbers ' + numberString + ' have a product of ' + product + '.');
    return output;
}
